...
namespace Obligatorio1
{
    internal class GestionHuespedes
    {
        ...
        {
            Huesped huesped1 = new Huesped("Jose", "Garcia", DateTime.Parse("24/10/1998"), "Uruguay", "Cédula", 55555555, 098111111, "garciajose@gmail.com");
            Huesped huesped2 = new Huesped("Jose", "Martinez", DateTime.Parse("27 /04/1987"), "Mexico", "Pasaporte", 333333, 987333222, "josemartinez@gmail.com");
            Huesped huesped3 = new Huesped("Maria", "Jimenez Arboleda", DateTime.Parse("03 /11/2001"), "Uruguay", "Cédula", 66666666, 093222222, "mariajiar@gmail.com");
        ...
        public static void ListarHuespedes(List<Usuario> users)
        {
            Console.Clear();
            bool salir = false;
